...
interface EliteCardProps {
    ...
    contentClassName?: string; // Inner content class
    delay?: number;
    title?: string;
    action?: ReactNode;
    noPadding?: boolean;
...
export default function EliteCard({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "relative overflow-hidden bg-surface border border-[rgba(30,58,138,0.08)] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.02),0_2px_4px_-1px_rgba(0,0,0,0.02)] rounded-[16px]",
                className
            )}
        >
            {/* Gradient Top Border */}
