...
BEGIN
    ...
    -- 2. Get Modality ID (Armas Cortas)
    SELECT id INTO v_modalidad_id FROM modalidades WHERE nombre ILIKE '%Armas Cortas%' LIMIT 1;
    ...
    IF v_modalidad_id IS NULL THEN
        RAISE EXCEPTION 'Modalidad "Armas Cortas" not found';
    END IF;
    ...
    VALUES (
        '1a Fecha - Cartel: Armas Cortas - C.I.T.',
        '2026-03-07',
        '09:00',
    ...
    INSERT INTO eventos (titulo, fecha, hora, ubicacion, ubicacion_url, club_id, modalidad_id, tipo_evento_id)
    VALUES (
        '2a Fecha - Cartel: Armas Cortas - C.I.T.',
        '2026-05-09',
        '09:00',
        'Comando de Ingeniería del Ejército',
        'https://maps.app.goo.gl/ScXyL13q2A1Cc1Se9?g_st=iw',
    ...
    INSERT INTO eventos (titulo, fecha, hora, ubicacion, ubicacion_url, club_id, modalidad_id, tipo_evento_id)
    VALUES (
        '3a Fecha - Cartel: Armas Cortas - C.I.T.',
        '2026-07-04',
        '09:00',
        'Comando de Ingeniería del Ejército',
        'https://maps.app.goo.gl/ScXyL13q2A1Cc1Se9?g_st=iw',
    ...
    INSERT INTO eventos (titulo, fecha, hora, ubicacion, ubicacion_url, club_id, modalidad_id, tipo_evento_id)
    VALUES (
        '4a Fecha - Cartel: Armas Cortas - C.I.T.',
        '2026-09-05',
        '09:00',
        'Comando de Ingeniería del Ejército',
        'https://maps.app.goo.gl/ScXyL13q2A1Cc1Se9?g_st=iw',
    ...
    INSERT INTO eventos (titulo, fecha, hora, ubicacion, ubicacion_url, club_id, modalidad_id, tipo_evento_id)
    VALUES (
        '5a Fecha - Cartel: Armas Cortas - C.I.T.',
        '2026-10-31',
        '09:00',
        'Comando de Ingeniería del Ejército',
        'https://maps.app.goo.gl/ScXyL13q2A1Cc1Se9?g_st=iw',
    ...
    RAISE NOTICE 'Eventos insertados correctamente.';
END $$;
